...
function CheckBox({ label, selected = false, onChange = () => {} }) {
  return (
    <div className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      ...
      />
      <label htmlFor="checkbox" className="font-light select-none">
        {label}
      </label>
    </div>
  );
...
function RadioButton({ label, selected = false, onChange = () => {} }) {
  return (
    <div className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      ...
      />
      <label htmlFor="radio" className="font-light select-none">
        {label}
      </label>
    </div>
  );
...
export default function AllRooms() {
  ...
  function matchesPriceRange(room) {
    return (
  ...
  // function to filter rooms based on serach parameter
  ...
  // function to filter and sort rooms based on the selected filters and sort options
          ...
          >
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div className="flex items-center">
                <StarRating />
                <p className="ml-2 text-gray-800">200+ reviews</p>
              </div>
